  ...
  /**
    ...
    **/
    ...
    protected function configuraCobreDireto(){
      ...
      //$file=dirname(dirname(dirname(__FILE__))).'/ps_cobredireto.cfg.php';
      ...
      /**
       * Versão anterior, pegando o wsdl local
       *
       * $this->ambiente = defined('CD_AMBIENTE')? CD_AMBIENTE : 'producao';
       * $this->__url = ($this->ambiente == 'producao') ?
       *     dirname(__FILE__).'/importWSDL/producao.wsdl'// importa WSDL (ambiente de produção)
       *     : dirname(__FILE__).'/importWSDL/teste.wsdl'; // importa WSDL (ambiente de teste)
       */
